# MirrorFlow v2 n8n Workflows

This directory contains n8n workflow templates for the MirrorFlow v2 architecture.
...
Set these in n8n:
- `MIRRORFLOW_API_URL`: MirrorFlow API base URL (e.g., `http://localhost:8000`)
...
1. Fetches enabled sources from MirrorFlow API
